...
RUN mv qpid-dispatch-master/ qpid-dispatch-1.10.0/
RUN tar -z -cf qpid-dispatch-1.10.0.tar.gz qpid-dispatch-1.10.0/
RUN rm -rf master.tar.gz qpid-dispatch-1.10.0/
