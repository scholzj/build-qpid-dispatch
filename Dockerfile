...
RUN wget https://github.com/apache/qpid-dispatch/archive/1.0.1-rc1.tar.gz
RUN tar -xf 1.0.1-rc1.tar.gz
RUN mv qpid-dispatch-1.0.1-rc1/ qpid-dispatch-1.0.1/
RUN tar -z -cf qpid-dispatch-1.0.1.tar.gz qpid-dispatch-1.0.1/
RUN rm -rf 1.0.1-rc1.tar.gz qpid-dispatch-1.0.1/
