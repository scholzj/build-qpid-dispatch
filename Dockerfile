...
RUN wget https://github.com/apache/qpid-dispatch/archive/0.8.1-rc1.tar.gz
RUN tar -xf 0.8.1-rc1.tar.gz
RUN mv qpid-dispatch-0.8.1-rc1/ qpid-dispatch-0.8.1/
RUN tar -z -cf qpid-dispatch-0.8.1.tar.gz qpid-dispatch-0.8.1/
RUN rm -rf 0.8.1.tar.gz qpid-dispatch-0.8.1/
