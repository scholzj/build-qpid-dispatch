...
RUN wget https://github.com/apache/qpid-dispatch/archive/0.8.0-rc3.tar.gz
RUN tar -xf 0.8.0-rc3.tar.gz
RUN mv qpid-dispatch-0.8.0-rc3/ qpid-dispatch-0.8.0/
RUN tar -z -cf qpid-dispatch-0.8.0.tar.gz qpid-dispatch-0.8.0/
RUN rm -rf 0.8.0-rc3.tar.gz qpid-dispatch-0.8.0/
